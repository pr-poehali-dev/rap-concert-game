...
const ARTISTS: Artist[] = [
  ...
  // ─── ЗАРУБЕЖНЫЕ — ЛЁГКИЕ ─────────────────────────────────────
  {
    ...
    bpm: 112,
    color: '#C8A951',
    tracks: ['God\'s Plan', 'Hotline Bling', 'One Dance'],
    locked: false,
  },
  {
    id: 'post_malone',
    ...
    bpm: 110,
    color: '#A8C4FF',
    tracks: ['Rockstar', 'Sunflower', 'Circles'],
    locked: false,
  },
  {
    id: 'juice_wrld',
    ...
    bpm: 108,
    color: '#7B2FBE',
    tracks: ['Lucid Dreams', 'All Girls Are the Same', 'Righteous'],
    locked: false,
  },
  {
    id: 'lil_nas',
    ...
    bpm: 114,
    color: '#FF6B9D',
    tracks: ['Old Town Road', 'MONTERO', 'Industry Baby'],
    locked: false,
  },
  {
    id: 'xxxtentacion',
  ...
  // ─── ЗАРУБЕЖНЫЕ — СРЕДНИЕ ────────────────────────────────────
  {
    ...
    bpm: 140,
    color: '#FF5500',
    tracks: ['SICKO MODE', 'Goosebumps', 'Antidote'],
    locked: false,
  },
  {
    id: 'lil_uzi',
    ...
    bpm: 138,
    color: '#FF2079',
    tracks: ['XO Tour Llif3', 'The Way Life Goes', 'Futsal Shuffle'],
    locked: false,
  },
  {
    id: 'young_thug',
    ...
    bpm: 136,
    color: '#00FA9A',
    tracks: ['Digits', 'Best Friend', 'Wyclef Jean'],
    locked: false,
  },
  {
    id: 'future',
    ...
    bpm: 133,
    color: '#4169E1',
    tracks: ['Mask Off', 'March Madness', 'Life is Good'],
    locked: false,
  },
  {
    id: 'lil_baby',
    ...
    bpm: 130,
    color: '#FF8C00',
    tracks: ['Drip Too Hard', 'Emotionally Scarred', 'Sum 2 Prove'],
    locked: false,
  },
  {
    id: 'gunna',
    ...
    bpm: 127,
    color: '#FFD700',
    tracks: ['Drip or Drown', 'Paid in Full', 'DOLLAZ ON MY HEAD'],
    locked: false,
  },
  {
    id: 'roddy_ricch',
    ...
    bpm: 129,
    color: '#20B2AA',
    tracks: ['The Box', 'High Fashion', 'Late at Night'],
    locked: false,
  },
  ...
  // ─── ЗАРУБЕЖНЫЕ — СЛОЖНЫЕ ────────────────────────────────────
  {
    ...
    bpm: 170,
    color: '#CC0000',
    tracks: ['Magnolia', 'Wokeuplikethis*', 'Sky'],
    locked: false,
  },
  {
    id: 'kendrick',
    name: 'Kendrick Lamar',
    emoji: '👁',
    genre: 'Сознательный рэп',
    difficulty: 'hard',
    bpm: 158,
    color: '#1DB954',
    tracks: ['HUMBLE.', 'DNA.', 'Alright'],
    locked: false,
  },
  {
    id: 'tyler',
    ...
    bpm: 152,
    color: '#ADFF2F',
    tracks: ['EARFQUAKE', 'See You Again', 'Lumberjack'],
    locked: false,
  },
  {
    id: 'denzel_curry',
    ...
    bpm: 164,
    color: '#FF4500',
    tracks: ['Bulls on Parade', 'CLOUT COBAIN', 'DIET_'],
    locked: false,
  },
  {
    id: 'jpegmafia',
    name: 'JPEGMAFIA',
    emoji: '📺',
    genre: 'Экспериментальный',
    difficulty: 'hard',
    bpm: 168,
    color: '#9400D3',
    tracks: ['Bald!', 'ROUGH ft. Danny Brown', 'Hazard Duty Pay!'],
    locked: false,
  },
  {
    id: 'nle_choppa',
    ...
    bpm: 163,
    color: '#00CED1',
    tracks: ['Shotta Flow', 'Camelot', 'Walk Em Down'],
    locked: false,
  },
  ...
  {
    id: 'carti_opium',
    name: 'CARTI OPIUM MODE',
    emoji: '🧛‍♂️',
    genre: 'WLR',
    difficulty: 'legendary',
    bpm: 195,
    color: '#FF0000',
    tracks: ['New Tank', 'Stop Breathing', 'Vamp Anthem'],
    locked: true,
  },
  {
    id: 'tupac_ru',
    ...
    bpm: 175,
    color: '#FFD700',
    tracks: ['All Eyez on Me', 'Changes', 'California Love'],
    locked: true,
  },
  {
    id: 'legendary',
